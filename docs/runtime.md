...
Each `createI18n(catalogs)` call owns a distinct lexical scope. `i18n.text()`
...
The application remains responsible for choosing a locale. Unknown locales and
missing messages throw rather than silently crossing catalog boundaries.
